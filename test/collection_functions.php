...
class Collection_main extends TestCase
{
    ...
    public function test_success_get_feedback()
    {
        ...
        $expectedOutput='<div class="flexContainer"><div class="box"><h2>$cycle</h2><div class="scenarioContainer"><h3>  " . $scenario["name"] . "</h3><div class="scenarioContentNull">Not Owned</div><div class="scenarioContentNull">Not Played</div></div></div><div class="box"><h2>$cycle</h2><div class="scenarioContainer"><h3>  " . $scenario["name"] . "</h3><div class="scenarioContentNull">Not Owned</div><div class="scenarioContent">Played</div></div></div></div>';
